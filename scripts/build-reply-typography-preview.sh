...
app_dir="$PWD/build/Reply Typography Preview.app"
...
swiftc -O -swift-version 5 -parse-as-library -I "$bin_dir/Modules" \
    ...
    Sources/AgentWorkbench/ReplyMarkdownView.swift Tests/ReplyTypographyPreview/App.swift \
    "${objects[@]}" -o "$app_dir/Contents/MacOS/ReplyTypographyPreview"
cat > "$app_dir/Contents/Info.plist" <<'PLIST'
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0"><dict>
<key>CFBundleIdentifier</key><string>dev.agentworkbench.replytypographypreview</string>
<key>CFBundleName</key><string>Reply Typography Preview</string>
<key>CFBundleExecutable</key><string>ReplyTypographyPreview</string>
