...
app="$PWD/build/Localization Preview.app"
...
swiftc -O -swift-version 5 -parse-as-library -I "$bin_dir/Modules" \
    ...
    Sources/AgentWorkbench/UILocalization.swift Sources/AgentWorkbench/WorkspaceSplitView.swift Sources/AgentWorkbench/WorkspaceSidebarShell.swift Tests/LocalizationPreview/App.swift \
    "${objects[@]}" -o "$app/Contents/MacOS/LocalizationPreview"
cp -R Resources/Localization/*.lproj "$app/Contents/Resources/"
cat > "$app/Contents/Info.plist" <<'PLIST'
<?xml version="1.0" encoding="UTF-8"?>
<plist version="1.0"><dict>
<key>CFBundleIdentifier</key><string>dev.perch.localization-preview</string>
<key>CFBundleName</key><string>Localization Preview</string>
<key>CFBundleExecutable</key><string>LocalizationPreview</string>
