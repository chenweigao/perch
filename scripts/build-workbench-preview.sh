...
app_dir="$PWD/build/Workbench Preview.app"
...
swiftc -O -swift-version 5 -parse-as-library -I "$bin_dir/Modules" \
    ...
    Tests/WorkbenchPreview/App.swift \
    "${objects[@]}" -o "$app_dir/Contents/MacOS/WorkbenchPreview"
cat > "$app_dir/Contents/Info.plist" <<'PLIST'
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
<plist version="1.0"><dict>
<key>CFBundleIdentifier</key><string>dev.agentworkbench.dashboardpreview</string>
<key>CFBundleName</key><string>Workbench Preview</string>
<key>CFBundleExecutable</key><string>WorkbenchPreview</string>
